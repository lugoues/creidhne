...
func TestCmdInit(t *testing.T) {
	...
	for _, f := range []string{"cue.mod/module.cue", "main.cue", ".crei/config.toml", ".crei/config.schema.json", "cue.mod/usr", "registries/images.cue", "registries/secrets.cue", "registries/assets.cue"} {
